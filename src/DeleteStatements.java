...
public class DeleteStatements extends JPanel {

	JTextArea input;
	JTextArea output;
	JTextField operation;

	public DeleteStatements() {
		...
		input.setToolTipText("<html>Drop your tab delemited excel data here in the form of:<br/>TableName<br/>column1  column2   column3<br/>data1_1  data2_1 data3_1<html>");
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (split.length > 2) {
					...
					for (int i = 2; i < split.length; i++) {
						...
						items.add("DELETE FROM " + table + " WHERE "
								+ buildWhere(columns, data) + ";");
					}
		...
		JPanel p = new JPanel();
		p.add(new JLabel(
				"<html><div style=\"text-align: center;\"><h2>Delete Statements</h2><p>Input<p></div></html>"));
		add(p);
		add(scroll1);
		...
		p3.add(new JLabel(
				"<html><div style=\"text-align: center;\"><p>Output</p></div></html>"));
		add(p3);
		add(scroll2);
	}

	private String buildWhere(String[] columns, String[] data) {
